...
console.log(result_5)   // '4px' -це string ; 3 - це number. В такому випадку відбувається конкатинація
                        // (Вивід в консолі : 4px3) 
...
console.log(result_10)          // Тут при додаванні відбудется конкатинація. При конкатинації string з іншими типами данних, завжди виводиться тип данных string. 
                                // Тому в цьому виразі виведеться null але з типом данных не object а string. 
                                //  Вивід в консолі : null
console.log(typeof result_10)   //   Вивід в консолі : string
